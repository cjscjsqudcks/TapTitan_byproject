...
public class PetstoreActivity extends AppCompatActivity {
    ...
    Button pst, clbtn;
    int temp;
    int empty,count,dpt,dps,mlife,plife,gold,kill,pet;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle("Tap Titan");
        setContentView(R.layout.petstore);

        pst = (Button)findViewById(R.id.pst1);
            ...
            public void onClick(View v) {
                if (temp == 0){
                    ...
                    if(gold>=150){
                        gold-=150;
                        temp = 1;
                        final LinearLayout layout = (LinearLayout)View.inflate(getApplicationContext(),R.layout.popup_activity,null);
                        AlertDialog.Builder dialog = new AlertDialog.Builder(PetstoreActivity.this);
                        dialog.setTitle("당신의 펫입니다.").setMessage("")
                    ...
                    Toast.makeText(getApplicationContext(),"더이상 펫을 구매할 수 없습니다.", Toast.LENGTH_LONG).show();
                }
                //처음엔 구매 이후엔 토스트메세지 "더이상 펫을 구매할수 없습니다."
            }
        });
